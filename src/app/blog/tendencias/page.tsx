            ...
            <div className="px-3">
              <div className="row">
                <div className="col-12">
                  <h2 className="text-primary-violet-secondary font-bold text-5xl">
                    Blog
                  </h2>
                  <hr className="my-3" />
                  <h3 className="text-primary-violet-secondary text-base">
                    TENDENCIAS DE HOY
                  </h3>
                  <hr className="my-3" />
                </div>
                ...
                <div className="col-12">
                  ...
                  <div className="row">
                    <div className="col flex justify-center">
                      <a
                        href="#"
                        className="text-primary-violet-secondary/70 underline "
                      >
                        Ver todo
                      </a>
                    </div>
                    <div className="col flex justify-center">
                      <a href="#" className="text-primary-violet-secondary/70">
                        Tendencias
                      </a>
                    </div>
                    <div className="col flex justify-center">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      ...
                      <p className="text-base text-zinc-700 font-bold mb-3">
                        Como recuperar la pasión de tu pareja después de los 50
                        años
                      </p>
                      <p className="text-sm text-zinc-700 mb-3">
                        Recuperar la pasión en el matrimonio después de los 50
                        años es posible y puede ser una experiencia
                        enriquecedora para ambos. Aquí hay algunos consejos para
                        avivar el fuego en su relación.
                      </p>
                ...
                <div className="col-12 mb-5">
                  <div className="row">
                    ...
                    <div className="col">
                      ...
                      <p className="text-base text-zinc-700 font-bold mb-3">
                        Cómo afectará la reforma a pensionados que ganan más de
                        10 millones de pesos al mes
                      </p>
                      <p className="text-sm text-zinc-700 mb-3">
                        Las pensiones de más de diez millones de pesos están en
                        la mira de la próxima reforma tributaria, tema polémico
                        que ha dado de qué hablar
                      </p>
                ...
                <div className="col-12 mb-5">
                  <div className="row">
                    ...
                    <div className="col">
                      ...
                      <p className="text-base text-zinc-700 font-bold mb-3">
                        Destinos ideales para disfrutar cuando tienes 50 o más
                      </p>
                      <p className="text-sm text-zinc-700 mb-3">
                        Colombia ofrece una gran variedad de destinos ideales
                        para los mayores de 50 años que buscan experiencias
                        enriquecedoras y relajantes
                      </p>
                      <p className="text-zinc-700 text-sm">Jul 24</p>
                    </div>
                  </div>
